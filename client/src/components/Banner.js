...
import "../assets/img/Hanzala_resume.pdf";
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`I'm Hanzala Shaikh`}</h1> <h1> <span className="txt-rotate" dataPeriod="2300" data-rotate='[ "Media Artist", "AR Creator", "Programmer" ]'><span className="wrap">{text}</span></span></h1>
                  ...
                  <button onClick={() => console.log('connect')}><a href = "../assets/img/Hanzala_resume.pdf" download>Download Resume</a> <a href = "../assets/img/Hanzala_resume.pdf" download>
                  <ArrowRightCircle size={25} /></a> </button>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
